...
class BaseActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        openFragment(stresslevelapp.tesside.belidesravan.StressHomeFragment())
...
//            .addToBackStack(null).commit()
    ...
    fun onClickListener()
    {
        ...
        btSummaryTest.setOnClickListener {
            ...
            openFragment(stresslevelapp.tesside.belidesravan.TestResultFragment())
        ...
        btMyProfile.setOnClickListener {
            openFragment(stresslevelapp.tesside.belidesravan.ProfileFragment())
