...
class DeleteTestActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            DeleteTestRecordActivity(this)
        }
    }
}

@Composable
fun DeleteTestRecordActivity(context: Context = LocalContext.current) {
